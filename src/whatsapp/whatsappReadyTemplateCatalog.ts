 ...
 * Catalog rows are shared definitions only — Meta create/approval is per tenant WABA.
 */
...
export const WHATSAPP_READY_TEMPLATE_CATALOG: WhatsAppReadyTemplateCatalogItem[] = [
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, {{2}} tutarındaki ödemenizin son ödeme tarihi {{3}}’tür. Ödeme bilgisi: {{4}}',
    variables: [
  ...
  },
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, {{2}} tutarındaki ödemenizin vadesi {{3}} tarihinde geçmiştir. Lütfen en kısa sürede ödeme yapın: {{4}}',
    variables: [
  ...
  },
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, {{2}} tutarındaki ödemeniz {{3}} tarihinde alınmıştır. Teşekkür ederiz. Referans: {{4}}',
    variables: [
  ...
  },
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, {{2}} tarihindeki randevunuzu hatırlatmak isteriz. Saat: {{3}}. Konum / not: {{4}}',
    variables: [
  ...
  },
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, randevunuz güncellendi. Yeni tarih: {{2}}, saat: {{3}}. Detay: {{4}}',
    variables: [
  ...
  },
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, {{2}} tarihli randevunuz iptal edilmiştir. Yeni randevu için: {{3}}',
    variables: [
  ...
  },
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, {{2}} numaralı siparişiniz alınmıştır. Toplam: {{3}}. Takip: {{4}}',
    variables: [
  ...
  },
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, {{2}} numaralı siparişiniz hazırlanıyor. Tahmini süre: {{3}}. Detay: {{4}}',
    variables: [
  ...
  },
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, {{2}} numaralı siparişiniz kargoya verildi. Kargo: {{3}}. Takip no: {{4}}',
    variables: [
  ...
  },
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, {{2}} işlemi için {{3}} belgesine ihtiyacımız var. Son tarih: {{4}}',
    variables: [
  ...
  },
  {
    ...
    category: 'UTILITY',
    language: 'tr',
    bodyText: 'Merhaba {{1}}, bilgilendirme: {{2}}. Detay: {{3}}',
    variables: [
  ...
  },
  {
    ...
    language: 'tr',
    bodyText:
      'Merhaba {{1}}, {{2}} kampanyamız başladı! Avantaj: {{3}}. Detaylar: {{4}}',
    variables: [
...
/** Count Meta-style {{n}} placeholders in body text. */
